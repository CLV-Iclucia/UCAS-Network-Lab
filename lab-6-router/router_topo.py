...
if __name__ == '__main__':
    ...
    # for h1
    # run ping 10.0.1.1 and output to output-h1-r1.txt
    # run ping 10.0.2.22 and output to output-h1-h2.txt
    # run ping 10.0.3.33 and output to output-h1-h2.txt
    # ping 10.0.3.11
    # ping 10.0.4.1
    net.start()
    # h1.cmd('ping 10.0.1.1 &> output-h1-r1.txt')
    # h1.cmd('ping 10.2.22 &> output-h1-h2.txt')
    # h1.cmd('ping 10.3.33 &> output-h1-h3.txt')
    # h1.cmd('ping 10.0.3.11 &> output-h1-icmp-1.txt')
    # h1.cmd('ping 10.0.4.1 &> output-h1-icmp-2.txt')
    # time.sleep(10)
    CLI(net)
    net.stop()
