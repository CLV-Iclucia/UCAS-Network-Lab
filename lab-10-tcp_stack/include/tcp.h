...
#define TCP_MAX_PACAKET_SIZE 1514
#define TCP_MSS (TCP_MAX_PACAKET_SIZE - ETHER_HDR_SIZE - IP_BASE_HDR_SIZE - TCP_BASE_HDR_SIZE)
...
enum tcp_cc_state {
  TCP_CC_CONGESTION_AVOIDANCE,
  TCP_CC_FAST_RECOVERY,
  TCP_CC_SLOW_START,
};
